...
#define LOAD_CHUNK  (16)
    ...
    for (ii = 0; ii < length; ii += this_write) {
        ...
        /*if (mpu_write_mem(ii, this_write, (unsigned char*)&firmware[ii])) Dan added the following 3 lines*/
        ...
        if (mpu_read_mem(ii, this_write, cur))
            return -1;
        /*if (memcmp(firmware+ii, cur, this_write)) Dan added the following line*/
